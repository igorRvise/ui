import { createStyles, RviseSize, RviseNumberSize, RviseColor, RviseGradient, RviseTheme } from '@rviseui/styles'
...
export default createStyles((theme, { color, size, radius, gradient, fullWidth, variant }: BadgeStylesParams) => {
