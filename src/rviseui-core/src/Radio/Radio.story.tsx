import { RVISE_SIZES, RviseProvider } from '@rviseui/styles'
...
export function Sizes() {
  const items = RVISE_SIZES.map((size) => (
...
export function WithDesciprtion() {
  return (
    <Stack sx={{ width: 300, padding: 20 }}>
      <Radio description="This is left Checkbox" labelPosition="left" label="Hello from left" value="1" />
      <Radio description="This is right Checkbox" labelPosition="right" label="Hello from right" value="1" />
    </Stack>
  )
}
