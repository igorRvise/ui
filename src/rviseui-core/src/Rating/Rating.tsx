...
import { DefaultProps, RviseSize, useComponentDefaultProps, Selectors, RviseColor } from '@rviseui/styles'
import { useUncontrolled, clamp, useMergedRef, useId } from '@rviseui/hooks'
import { Box } from '../Box'
...
Rating.displayName = '@rviseui/core/Rating'
