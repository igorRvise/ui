...
import { Box, RviseSize, Selectors, DefaultProps } from '@rviseui/core'
    ...
    const handleDayKeyDown = (
      ...
      switch (event.key) {
        ...
        case 'ArrowRight': {
          ...
          if (
            isNotLastCell ||
            (monthIndex + 1 < amountOfMonths && daysRefs.current[monthIndex + 1][payload.rowIndex])
          ) {
            if (isNotLastCell) {
        ...
        case 'ArrowLeft': {
          ...
          } else if (monthIndex > 0 && daysRefs.current[monthIndex - 1][payload.rowIndex]) {
...
CalendarBase.displayName = '@rviseui/dates/CalendarBase'
