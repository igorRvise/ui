...
import { getSafeId } from '@rviseui/utils'
import { useUncontrolled, useId } from '@rviseui/hooks'
import { ClassNames, RviseColor, RviseNumberSize, Styles } from '@rviseui/styles'
...
TabsProvider.displayName = '@rviseui/core/TabsProvider'
