...
import { checkAccessibility, itSupportsFocusEvents, itSupportsSystemProps, itSupportsInputProps } from '@rviseui/tests'
import { Textarea, TextareaProps } from './Textarea'

const defaultProps: TextareaProps = {}

describe('@rviseui/core/Textarea', () => {
  ...
  itSupportsSystemProps({
    component: Textarea,
    props: defaultProps,
    displayName: '@rviseui/core/Textarea',
