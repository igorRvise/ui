...
import { DefaultProps, RviseNumberSize, getDefaultZIndex, useComponentDefaultProps } from '@rviseui/styles'
...
export const LoadingOverlay = forwardRef<HTMLDivElement, LoadingOverlayProps>((props, ref) => {
  ...
  return (
    <Transition duration={transitionDuration} exitDuration={exitTransitionDuration} mounted={visible} transition="fade">
      {(transitionStyles) => (
        <Box
...
LoadingOverlay.displayName = '@rviseui/core/LoadingOverlay'
