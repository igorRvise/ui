...
export default createStyles(
  (theme, { scrollbarSize, offsetScrollbars, scrollbarHovered, hidden }: ScrollAreaStylesParams, getRef) => ({
    root: {
      overflow: 'hidden',
    },
    ...
    scrollbar: {
      ...
      '&:hover': {
        ...
        [`& .${getRef('thumb')}`]: {
          backgroundColor:
            theme.colorScheme === 'dark' ? theme.fn.rgba(theme.white, 0.5) : theme.fn.rgba(theme.black, 0.5),
        },
      },
