...
import { useMergedRef, useId } from '@rviseui/hooks'
...
export interface DatePickerBaseSharedProps
  extends InputSharedProps,
    ...
    Omit<React.ComponentPropsWithoutRef<'input'>, 'value' | 'defaultValue' | 'placeholder' | 'size'> {
...
const defaultTransition: RviseTransition = {
...
DatePickerBase.displayName = '@rviseui/dates/DatePickerBase'
