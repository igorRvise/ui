...
describe('@rviseui/core/Switch', () => {
  ...
  itSupportsSystemProps({
    component: Switch,
    props: defaultProps,
    displayName: '@rviseui/core/Switch',
  ...
  it('render onLabel and offLabel if provided', () => {
    const { container: unChecked } = render(<Switch offLabel={<span className="offLabel">Off</span>} />)
    const { container: checked } = render(<Switch checked onLabel={<span className="onLabel">On</span>} />)
