...
const getStates = (props?: any) => (
  <div style={{ maxWidth: 400, padding: 50 }}>
    ...
    <Input placeholder="Invalid" icon={<IconSearch />} invalid style={{ marginTop: 15 }} {...props} />
    ...
    <Input style={{ marginTop: 15 }} placeholder="With right section" rightSection={actionIcon} {...props} />
    <Input
      style={{ marginTop: 15 }}
