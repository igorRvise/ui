...
const queries = {
  getLabel: (container: HTMLElement) => container.querySelector('.rviseui-InputWrapper-label'),
  getError: (container: HTMLElement) => container.querySelector('.rviseui-InputWrapper-error'),
  getRequired: (container: HTMLElement) => container.querySelector('.rviseui-InputWrapper-required'),
  getDescription: (container: HTMLElement) => container.querySelector('.rviseui-InputWrapper-description'),
}

describe('@rviseui/core/InputWrapper', () => {
  itRendersChildren(InputWrapper, defaultProps)
  itSupportsSystemProps({
    component: InputWrapper,
    props: defaultProps,
    displayName: '@rviseui/core/InputWrapper',
  ...
  it('renders correct error, description and label', () => {
    const { container } = render(
      <InputWrapper {...defaultProps} label="test-label" error="test-error" description="test-description" />,
    )
