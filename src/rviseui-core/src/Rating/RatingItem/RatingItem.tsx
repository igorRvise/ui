...
import { RviseSize, Selectors, DefaultProps, RviseColor } from '@rviseui/styles'
import { Box } from '../../Box'
    ...
    <>
      ...
      <Box
        ...
        <Box
          ...
          sx={
            fractionValue === 1 ? undefined : { clipPath: `inset(0 ${active ? 100 - fractionValue * 100 : 100}% 0 0)` }
          }>
          {full
...
RatingItem.displayName = '@rviseui/core/RatingItem'
