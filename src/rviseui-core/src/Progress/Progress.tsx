...
import { DefaultProps, RviseNumberSize, RviseColor, Selectors, useComponentDefaultProps } from '@rviseui/styles'
import { Box } from '../Box'
...
export const Progress = forwardRef<HTMLDivElement, ProgressProps>((props, ref) => {
  ...
  const segments = Array.isArray(sections)
    ? getCumulativeSections(sections).map(
        (
          { tooltip, accumulated, value: sectionValue, label: sectionLabel, color: sectionColor, ...sectionProps },
          index,
        ) => (
...
Progress.displayName = '@rviseui/core/Progress'
