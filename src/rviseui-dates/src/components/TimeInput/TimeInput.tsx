...
import { useDidUpdate, useMergedRef, useId } from '@rviseui/hooks'
...
export type TimeInputStylesNames = Selectors<typeof useStyles> | InputStylesNames | InputWrapperStylesNames
...
export const TimeInput = forwardRef<HTMLInputElement, TimeInputProps>((props: TimeInputProps, ref) => {
  const {
    required,
    label,
    error,
...
TimeInput.displayName = '@rviseui/dates/TimeInput'
