import { createStyles, RviseNumberSize, RviseSize, RviseColor } from '@rviseui/styles'
  ...
  (
    ...
    return {
      ...
      controlActive: {
        ...
        borderRadius: theme.fn.radius(radius),
        boxShadow: shouldAnimate ? (color || theme.colorScheme === 'dark' ? 'none' : theme.shadows.xs) : undefined,
      ...
      active: {
        ...
        transition: `transform ${shouldAnimate ? 0 : transitionDuration}ms ${theme.transitionTimingFunction}, width ${
