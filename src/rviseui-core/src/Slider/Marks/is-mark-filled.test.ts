...
describe('@rviseui/core/Slider/is-mark-filled', () => {
  ...
  it('correctly detects filled mark with offset and inverted slider', () => {
    ...
    expect(isMarkFilled({ mark: { value: 100 }, offset: 30, value: 90, inverted: true })).toBe(true)
    expect(isMarkFilled({ mark: { value: 40 }, offset: 10, value: 90, inverted: true })).toBe(false)
  })
})
