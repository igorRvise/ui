...
const LEVEL_ICON_SELECTOR = '.rviseui-CalendarHeader-calendarHeaderLevelIcon'

describe('@rviseui/dates/CalendarHeader', () => {
  ...
  it('does not render level icon if level control is disabled', () => {
    ...
    const { container: enabled } = render(<CalendarHeader {...defaultProps} nextLevelDisabled={false} />)
  ...
  it('has correct displayName', () => {
    expect(CalendarHeader.displayName).toStrictEqual('@rviseui/dates/CalendarHeader')
  })
})
