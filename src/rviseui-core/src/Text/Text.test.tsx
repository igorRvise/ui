...
describe('@rviseui/core/Text', () => {
  ...
  it('sets text-decoration based on strikethrough and underline props', () => {
    ...
    expectStyle({ strikethrough: true, underline: true }, { textDecoration: 'underline line-through' })
  })
  ...
  it('inherits text styles if inherit prop is true', () => {
    expectStyle({ inherit: true }, { fontFamily: 'inherit', fontSize: 'inherit', lineHeight: 'inherit' })
  })
})
