...
import { DefaultProps, useComponentDefaultProps, SystemProp, SpacingValue } from '@rviseui/styles'
  ...
  return (
    <Box
      ...
      sx={[
        { display: 'flex' },
        (theme) =>
          getSystemStyles({ gap, rowGap, columnGap, align, justify, wrap, direction }, theme, FLEX_SYSTEM_PROPS),
        ...packSx(sx),
      ]}
      ref={ref}
    />
...
Flex.displayName = '@rviseui/core/Flex'
