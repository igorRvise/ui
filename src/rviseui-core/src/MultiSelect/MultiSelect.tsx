...
import { useUncontrolled, useMergedRef, useDidUpdate, useScrollIntoView, useId } from '@rviseui/hooks'
import { DefaultProps, Selectors, getDefaultZIndex, useComponentDefaultProps } from '@rviseui/styles'
import { groupOptions } from '@rviseui/utils'
            ...
            <Input<'div'>
              ...
              <div className={classes.values}>
                ...
                <input
                  ...
                  disabled={disabled}
                  data-rviseui-stop-propagation={dropdownOpened}
                  autoComplete="off"
...
MultiSelect.displayName = '@rviseui/core/MultiSelect'
