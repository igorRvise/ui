...
describe('@rviseui/core/Rating', () => {
  ...
  it('supports uncontrolled state', async () => {
    ...
    const labelCheckedInput: HTMLInputElement = container.querySelector('input[name="click-test"][value="5"]:checked')
    expect(labelCheckedInput.value).toEqual('5')

    await userEvent.click(container.querySelector('input[name="click-test"][value="4"]'))
    const inputCheckedInput: HTMLInputElement = container.querySelector('input[name="click-test"][value="4"]:checked')
  ...
  it('selects 0, if value or defaultValue is null', () => {
    ...
    const checkedInputI: HTMLInputElement = container.querySelector('input[name="rating-null-value"]:checked')
    const checkedInputII: HTMLInputElement = container.querySelector('input[name="rating-null-defaultValue"]:checked')
