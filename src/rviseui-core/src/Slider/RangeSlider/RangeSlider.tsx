...
import { useMove, useUncontrolled, useMergedRef } from '@rviseui/hooks'
import { DefaultProps, RviseNumberSize, RviseColor, useRviseTheme, useComponentDefaultProps } from '@rviseui/styles'
      ...
      switch (event.key) {
        ...
        case 'ArrowRight': {
          ...
          setRangedValue(
            Math.min(
              Math.max(
                theme.dir === 'rtl' ? valueRef.current[focusedIndex] - step : valueRef.current[focusedIndex] + step,
                min,
              ),
              max,
            ),
...
RangeSlider.displayName = '@rviseui/core/RangeSlider'
