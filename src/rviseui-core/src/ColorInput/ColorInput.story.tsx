...
import { WithinOverlays } from '@rviseui/storybook'
import { DEFAULT_THEME, RVISE_SIZES } from '@rviseui/styles'
...
export function Sizes() {
  const sizes = RVISE_SIZES.map((size) => (
    <ColorInput size={size} label="Color input" placeholder="Pick color" format="rgba" style={{ marginTop: 20 }} />
  ))
