...
import { DefaultProps, Selectors, useRviseTheme, useComponentDefaultProps } from '@rviseui/styles'
import { ForwardRefWithStaticComponents, packSx } from '@rviseui/utils'
import { Box } from '../Box'
...
ScrollAreaAutosize.displayName = '@rviseui/core/ScrollAreaAutosize'
_ScrollArea.displayName = '@rviseui/core/ScrollArea'
