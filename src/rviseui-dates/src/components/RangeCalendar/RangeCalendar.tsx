...
export const RangeCalendar = forwardRef<HTMLDivElement, RangeCalendarProps>((props: RangeCalendarProps, ref) => {
  const {
    value,
    onChange,
    dayStyle,
...
RangeCalendar.displayName = '@rviseui/dates/RangeCalendar'
