...
export function itSupportsSystemProps<T extends React.FC>(options: Options<T>) {
  ...
  options.providerName &&
    itSupportsProviderDefaultProps(options.component, options.props, options.providerName, options.othersSelector)
  !shouldExcludeOthers && itSupportsOthers(options.component, options.props, options.othersSelector)
