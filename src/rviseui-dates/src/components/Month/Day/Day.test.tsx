...
describe('@rviseui/core/Month/Day', () => {
  ...
  it('sets data-rviseui-stop-propagation attribute if stopPropagation prop is true', () => {
    render(<Day {...defaultProps} stopPropagation />)
    expect(screen.getByRole('button')).toHaveAttribute('data-rviseui-stop-propagation', 'true')
  })
  ...
  it('has correct displayName', () => {
    expect(Day.displayName).toStrictEqual('@rviseui/core/Day')
  })
