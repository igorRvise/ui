import { createStyles, RviseTheme, CSSObject, RviseColor, RviseGradient, RviseTextSize } from '@rviseui/styles'

export interface TextStylesParams {
  color: 'dimmed' | RviseColor
  ...
  (
    ...
    return {
      root: {
        ...
        fontSize: inherit || size === undefined ? 'inherit' : theme.fn.size({ size, sizes: theme.fontSizes }),
