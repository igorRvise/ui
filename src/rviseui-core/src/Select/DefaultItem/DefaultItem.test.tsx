...
import { itSupportsClassName, itSupportsOthers, itSupportsStyle, itSupportsRef } from '@rviseui/tests'
...
describe('@rviseui/core/Autocomplete/DefaultItem', () => {
  ...
  it('has correct displayName', () => {
    expect(DefaultItem.displayName).toStrictEqual('@rviseui/core/DefaultItem')
  })
})
