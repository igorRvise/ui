...
import { DefaultProps, RviseColor, Selectors, RviseNumberSize, useComponentDefaultProps } from '@rviseui/styles'
import { useId } from '@rviseui/hooks'
...
export const Alert = forwardRef<HTMLDivElement, AlertProps>((props: AlertProps, ref) => {
  ...
  const { classes, cx } = useStyles({ color, radius, variant }, { classNames, styles, unstyled, name: 'Alert' })
...
Alert.displayName = '@rviseui/core/Alert'
