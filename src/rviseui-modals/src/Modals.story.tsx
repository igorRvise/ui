...
import { Button, Text, Group, Modal } from '@rviseui/core'
import {
  ModalsProvider,
  openConfirmModal,
  openContextModal,
    ...
    openConfirmModal({
      ...
      children: (
        <Text size="sm" color="dimmed">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione magnam modi vitae molestias unde tempora
          exercitationem fugit, ex repellat doloribus maiores facilis quo quis, itaque temporibus obcaecati vel iusto
          praesentium.
        </Text>
      ),
