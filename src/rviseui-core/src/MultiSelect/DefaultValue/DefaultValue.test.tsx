...
import { itSupportsClassName, itSupportsStyle, itSupportsOthers, checkAccessibility } from '@rviseui/tests'
...
describe('@rviseui/core/MultiSelect/DefaultValue', () => {
  ...
  it('has correct displayName', () => {
    expect(DefaultValue.displayName).toStrictEqual('@rviseui/core/MultiSelect/DefaultValue')
  })
})
