...
const demo = (
  <div style={{ padding: 60 }}>
    <div style={{ maxWidth: 400, marginLeft: 'auto', marginRight: 'auto' }}>
      ...
      <Notification onClose={() => {}} mt="xl" title="NotificationTitleSoLargeThatItWillUseOverflowEllipsisOption">
      ...
      <Notification color="green" onClose={() => {}} mt="xl" title="Success notification without icon">
        Your action was a complete success!
      </Notification>

      <Notification color="orange" onClose={() => {}} mt="xl" title="Danger notification without icon">
        You have done something wrong, too bad
      </Notification>

      <Notification color="grape" onClose={() => {}} mt="xl" title="Grape notification without icon">
        This action will not work very soon
      </Notification>
      ...
      <Notification color="gray" onClose={() => {}} mt="xl" title="Notification with a lot of content">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta nam cumque natus ea aliquid quo illo enim totam
        sunt voluptatum, dolorum blanditiis sint, porro aut asperiores ut maxime doloremque. Cumque.
      </Notification>
