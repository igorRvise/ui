...
import { DefaultProps, RviseNumberSize, useComponentDefaultProps, Selectors } from '@rviseui/styles'
...
export const _ColorSwatch = forwardRef<HTMLDivElement, ColorSwatchProps>((props, ref) => {
  const { color, size, radius, className, children, classNames, styles, unstyled, withShadow, ...others } =
...
_ColorSwatch.displayName = '@rviseui/core/ColorSwatch'
