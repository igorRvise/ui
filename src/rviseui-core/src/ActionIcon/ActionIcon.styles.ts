import { createStyles, RviseNumberSize, RviseColor, RviseTheme, RviseGradient } from '@rviseui/styles'
...
export default createStyles((theme, { color, size, radius, variant, gradient }: ActionIconStylesParams) => ({
  root: {
    ...
    '&:disabled, &[data-disabled]': {
      ...
      cursor: 'not-allowed',
      backgroundColor:
        variant === 'transparent' ? undefined : theme.fn.themeColor('gray', theme.colorScheme === 'dark' ? 8 : 1),
      borderColor:
        variant === 'transparent' ? undefined : theme.fn.themeColor('gray', theme.colorScheme === 'dark' ? 8 : 1),
