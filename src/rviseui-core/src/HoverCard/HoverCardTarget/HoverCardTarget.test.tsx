...
import { itThrowsContextError, patchConsoleError, createContextContainer } from '@rviseui/tests'
...
describe('@rviseui/core/HoverCardTarget', () => {
  ...
  it('has correct displayName', () => {
    expect(HoverCardTarget.displayName).toEqual('@rviseui/core/HoverCardTarget')
  })
})
