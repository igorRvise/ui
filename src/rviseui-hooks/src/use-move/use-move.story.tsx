...
const Demo = () => {
  ...
  return (
    <div>
      ...
      <div ref={ref} style={{ position: 'relative', height: 200, width: 200, backgroundColor: 'gray' }}>
        <div
          style={{
            position: 'absolute',
...
const HorizontalDemo = () => {
  ...
  return (
    <>
      <div style={{ color: active ? 'red' : 'blue', marginBottom: 10 }}>x: {Math.round(value * 100)}%</div>
      <div
        ref={ref}
        style={{
          width: 400,
