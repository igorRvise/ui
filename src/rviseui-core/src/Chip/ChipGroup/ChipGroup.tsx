...
import { RviseNumberSize, useComponentDefaultProps } from '@rviseui/styles'
...
export function ChipGroup<T extends boolean>(props: ChipGroupProps<T>) {
  const { value, defaultValue, onChange, spacing, multiple, children, unstyled, ...others } = useComponentDefaultProps(
    'ChipGroup',
    defaultProps as any,
    props,
  )
...
ChipGroup.displayName = '@rviseui/core/ChipGroup'
