...
import { itRendersChildren, itSupportsRef, itSupportsSystemProps } from '@rviseui/tests'
...
describe('@rviseui/core/Dialog', () => {
  ...
  it('has correct displayName', () => {
    expect(Dialog.displayName).toStrictEqual('@rviseui/core/Dialog')
  })
})
