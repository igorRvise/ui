...
import { DefaultProps, RviseNumberSize, RviseColor, Selectors } from '@rviseui/styles'
import { Box } from '../../Box'
...
export function Marks({
  ...
  const items = marks.map((mark, index) => (
    <Box className={classes.markWrapper} sx={{ left: `${getPosition({ value: mark.value, min, max })}%` }} key={index}>
      <div
...
Marks.displayName = '@rviseui/core/SliderMarks'
