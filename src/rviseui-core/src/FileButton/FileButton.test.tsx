...
import { checkAccessibility, itSupportsRef } from '@rviseui/tests'
...
describe('@rviseui/core/FileButton', () => {
  ...
  it('sets given input accept', () => {
    ...
    expect(document.querySelector('input[type="file"]')).toHaveAttribute('accept', 'image/png,image/jpeg')
  })

  it('has correct displayName', () => {
    expect(FileButton.displayName).toEqual('@rviseui/core/FileButton')
  })
})
