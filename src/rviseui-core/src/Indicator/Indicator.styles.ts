import { createStyles, CSSObject, RviseColor, RviseNumberSize, keyframes } from '@rviseui/styles'
...
export default createStyles(
  //@ts-ignore
  (theme, { radius, size, color, position, offset, inline, withBorder, withLabel, zIndex }: IndicatorStylesParams) => {
