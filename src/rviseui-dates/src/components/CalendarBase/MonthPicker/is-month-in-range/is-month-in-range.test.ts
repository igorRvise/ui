...
describe('@rviseui/dates/MonthPicker/is-month-in-range', () => {
  ...
  it('handles edge cases correctly', () => {
    expect(isMonthInRange({ date: new Date(2021, 1, 1), minDate: new Date(2021, 1, 13) })).toBe(true)
    expect(isMonthInRange({ date: new Date(2021, 0, 1), minDate: new Date(2021, 1, 13) })).toBe(false)

    expect(isMonthInRange({ date: new Date(2021, 1, 1), maxDate: new Date(2022, 1, 13) })).toBe(true)
    expect(isMonthInRange({ date: new Date(2021, 2, 1), maxDate: new Date(2022, 1, 13) })).toBe(true)
  })
})
