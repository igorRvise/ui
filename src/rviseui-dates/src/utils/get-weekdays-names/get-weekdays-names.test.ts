...
describe('@rviseui/dates/get-weekdays-names', () => {
  it('returns correct weekday names for given locale', () => {
    ...
    expect(getWeekdaysNames('en', 'sunday')).toStrictEqual(['Su', 'Mo', 'Tu', 'We', 'Th', 'Fr', 'Sa'])
    expect(getWeekdaysNames('ru', 'sunday')).toStrictEqual(['вс', 'пн', 'вт', 'ср', 'чт', 'пт', 'сб'])
  })
})
