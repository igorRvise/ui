...
const CONTROL_SELECTOR = '.rviseui-YearPicker-yearPickerControl'
const ACTIVE_CONTROL_SELECTOR = '.rviseui-YearPicker-yearPickerControlActive'

describe('@rviseui/dates/YearPicker', () => {
  ...
  it('renders correct amount of controls', () => {
    ...
    const { container: disabled } = render(<YearPicker {...defaultProps} minYear={2020} maxYear={2025} />)
  ...
  it('has correct displayName', () => {
    expect(YearPicker.displayName).toStrictEqual('@rviseui/dates/YearPicker')
  })
})
