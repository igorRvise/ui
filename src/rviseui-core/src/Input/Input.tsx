...
import { DefaultProps, RviseNumberSize, RviseSize, Selectors, useComponentDefaultProps } from '@rviseui/styles'
...
export const _Input = forwardRef<HTMLInputElement, InputProps>((props, ref) => {
  ...
  return (
    <Box className={cx(classes.wrapper, className)} sx={sx} style={style} {...systemStyles} {...wrapperProps}>
...
_Input.displayName = '@rviseui/core/Input'
