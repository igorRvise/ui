import { createStyles, RviseSize, RviseColor, RviseNumberSize } from '@rviseui/styles'
...
export default createStyles(
  (
    theme,
    { size, radius, color, transitionDuration, labelPosition, error, indeterminate }: CheckboxStylesParams,
    getRef,
  ) => {
