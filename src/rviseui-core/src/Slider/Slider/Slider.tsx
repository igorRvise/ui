...
import { useMergedRef, useMove, useUncontrolled, clamp } from '@rviseui/hooks'
import { DefaultProps, RviseColor, RviseNumberSize, useComponentDefaultProps, useRviseTheme } from '@rviseui/styles'
...
export interface SliderProps
  ...
  labelTransition?: RviseTransition
...
export const Slider = forwardRef<HTMLDivElement, SliderProps>((props, ref) => {
  ...
  const handleThumbMouseDown = (event: React.MouseEvent<HTMLDivElement> | React.TouchEvent<HTMLDivElement>) => {
...
Slider.displayName = '@rviseui/core/Slider'
