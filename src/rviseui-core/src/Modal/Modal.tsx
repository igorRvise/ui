...
import { useScrollLock, useFocusTrap, useFocusReturn, useId, useWindowEvent, useMergedRef } from '@rviseui/hooks'
import {
  DefaultProps,
  RviseNumberSize,
  RviseShadow,
...
export interface ModalProps
  extends Omit<DefaultProps<ModalStylesNames, ModalStylesParams>, RviseStyleSystemSize>,
          ...
          <>
            <Box id={baseId} className={cx(classes.root, className)} {...others}>
              ...
              <div
                ...
                onKeyDown={(event) => {
                  const shouldTrigger = (event.target as any)?.getAttribute('data-rviseui-stop-propagation') !== 'true'
...
Modal.displayName = '@rviseui/core/Modal'
