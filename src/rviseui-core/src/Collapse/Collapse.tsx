...
import { useReducedMotion } from '@rviseui/hooks'
import { DefaultProps, useComponentDefaultProps, useRviseTheme } from '@rviseui/styles'
...
Collapse.displayName = '@rviseui/core/Collapse'
