...
import { useUncontrolled, useMergedRef, upperFirst } from '@rviseui/hooks'
import { useRviseTheme, useComponentDefaultProps } from '@rviseui/core'
...
export const DatePicker = forwardRef<HTMLInputElement, DatePickerProps>((props: DatePickerProps, ref) => {
  ...
  const parseDate = (date: string) => (dateParser ? dateParser(date) : dayjs(date, dateFormat, finalLocale).toDate())
...
DatePicker.displayName = '@rviseui/dates/DatePicker'
