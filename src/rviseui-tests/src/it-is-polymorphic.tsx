...
export function itIsPolymorphic<P>(Component: React.ComponentType<P>, requiredProps: P, selector?: string) {
  it('is polymorphic', () => {
    ...
    const TestComponent = forwardRef((props: any, ref) => <mark data-test-prop ref={ref} {...props} />)
    const { container: withTag } = render(<Component component="a" href="https://rvise.dev" {...requiredProps} />)
