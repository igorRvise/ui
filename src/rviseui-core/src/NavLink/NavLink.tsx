...
import { DefaultProps, RviseColor, RviseNumberSize, Selectors, useComponentDefaultProps } from '@rviseui/styles'
import { createPolymorphicComponent } from '@rviseui/utils'
import { useUncontrolled } from '@rviseui/hooks'
...
export interface NavLinkProps extends DefaultProps<NavLinkStylesNames, NavLinkStylesParams> {
  ...
  childrenOffset?: RviseNumberSize
    ...
    <>
      <UnstyledButton
        ...
        {(withChildren || rightSection) && (
          <span className={classes.rightSection} data-rotate={(_opened && !disableRightSectionRotation) || undefined}>
            {withChildren
              ? rightSection || <ChevronIcon width={14} height={14} style={{ transform: 'rotate(-90deg)' }} />
              : rightSection}
          </span>
        )}
      </UnstyledButton>
...
_NavLink.displayName = '@rviseui/core/NavLink'
