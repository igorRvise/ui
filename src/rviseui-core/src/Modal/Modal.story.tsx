...
function WrappedModal(props: Omit<React.ComponentPropsWithoutRef<typeof Modal>, 'opened' | 'onClose'>) {
...
const content = Array(40)
  ...
  .map((_, index) => (
    <p key={index}>
      Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis nesciunt architecto beatae iure, aliquam
      laborum molestias ratione delectus sed cupiditate, nobis impedit eos vero neque magni minima repellendus! Beatae,
      illo.
    </p>
  ))
