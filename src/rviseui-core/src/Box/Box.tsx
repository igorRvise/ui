...
import { DefaultProps } from '@rviseui/styles'
...
export const _Box = forwardRef<HTMLDivElement, BoxProps & { component: any }>(
  ({ className, component, style, sx, ...others }, ref) => {
    ...
    return <Element ref={ref} className={useSx(sx, systemStyles, className)} style={style} {...rest} />
  },
)

_Box.displayName = '@rviseui/core/Box'
