...
import { DefaultProps, RviseNumberSize, Selectors, useComponentDefaultProps } from '@rviseui/styles'
...
export const Burger = forwardRef<HTMLButtonElement, BurgerProps>((props: BurgerProps, ref) => {
  ...
  const { classes, cx } = useStyles({ color, size, transitionDuration }, { classNames, styles, name: 'Burger' })
...
Burger.displayName = '@rviseui/core/Burger'
