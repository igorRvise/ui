...
import { itRendersChildren, checkAccessibility } from '@rviseui/tests'
...
describe('@rviseui/core/HoverCard', () => {
  ...
  it('has correct displayName', () => {
    expect(HoverCard.displayName).toEqual('@rviseui/core/HoverCard')
  })
})
